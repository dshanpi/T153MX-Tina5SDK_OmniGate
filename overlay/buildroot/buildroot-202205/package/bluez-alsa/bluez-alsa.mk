...
# Standard aptX and aptX HD negotiate successfully but their vendor-codec
# transport fails with ENOSYS on this BlueZ/BlueALSA/kernel combination.
# Keep the verified SBC-only sink until the transport layer is fixed.
